...
cse303.do_cmd(
    "Setting key k1 with invalid user.",
    "ERR_LOGIN",
    client.kvI(bob, "k1", filet1),
    server,
)
cse303.do_cmd(
    "Setting key k1 with invalid password.",
    "ERR_LOGIN",
    client.kvI(fakealice, "k1", filet1),
    server,
)
cse303.do_cmd("Setting key k1.", "OK__", client.kvI(alice, "k1", filet1), server)
cse303.do_cmd("Re-setting key k1.", "ERR_KEY", client.kvI(alice, "k1", filet1), server)
cse303.do_cmd(
    "Setting key k2 with binary data.", "OK__", client.kvI(alice, "k2", fileb1), server
)
cse303.build_file("toobig.dat", 1048577)
cse303.build_file("nottoobig.dat", 1048576)
cse303.do_cmd(
    "Setting key k3 with too large file.",
    "ERR_REQ_FMT",
    client.kvI(alice, "k3", "toobig.dat"),
    server,
)
cse303.do_cmd(
    "Setting key k4 with large file.",
    "OK__",
    client.kvI(alice, "k4", "nottoobig.dat"),
    server,
)
...
cse303.line()
cse303.do_cmd(
    "Getting key k1 with invalid user.", "ERR_LOGIN", client.kvG(bob, "k1"), server
)
cse303.do_cmd(
    "Getting key k1 with invalid password.",
    "ERR_LOGIN",
    client.kvG(fakealice, "k1"),
    server,
)
cse303.do_cmd(
    "Getting nonexistent key k11.", "ERR_KEY", client.kvG(alice, "k11"), server
)
cse303.do_cmd("Getting nonexistent key k3.", "ERR_KEY", client.kvG(alice, "k3"), server)
cse303.do_cmd("Getting text key k1.", "OK__", client.kvG(alice, "k1"), server)
cse303.check_file_result(filet1, "k1")
cse303.do_cmd("Getting binary key k2.", "OK__", client.kvG(alice, "k2"), server)
cse303.check_file_result(fileb1, "k2")
cse303.do_cmd("Getting large key k4.", "OK__", client.kvG(alice, "k4"), server)
...
cse303.line()
cse303.do_cmd(
    "Deleting key k1 with invalid user.", "ERR_LOGIN", client.kvD(bob, "k1"), server
)
cse303.do_cmd(
    "Deleting key k1 with invalid password.",
    "ERR_LOGIN",
    client.kvD(fakealice, "k1"),
    server,
)
cse303.do_cmd(
    "Deleting nonexistent key k11.", "ERR_KEY", client.kvD(alice, "k11"), server
)
cse303.do_cmd("Deleting text key k1.", "OK__", client.kvD(alice, "k1"), server)
cse303.do_cmd("Checking delete.", "ERR_KEY", client.kvG(alice, "k1"), server)
cse303.do_cmd("Deleting binary key k2.", "OK__", client.kvD(alice, "k2"), server)
...
cse303.line()
cse303.do_cmd(
    "Upserting key k1 with invalid user.",
    "ERR_LOGIN",
    client.kvU(bob, "k1", filet1),
    server,
)
cse303.do_cmd(
    "Upserting key k1 with invald password.",
    "ERR_LOGIN",
    client.kvU(fakealice, "k1", filet1),
    server,
)
cse303.do_cmd(
    "Upserting key k1 with text value.",
    "OK_INSERT",
    client.kvU(alice, "k1", filet1),
    server,
)
cse303.do_cmd("Getting key k1.", "OK__", client.kvG(alice, "k1"), server)
cse303.check_file_result(filet1, "k1")
cse303.do_cmd(
    "Upserting key k2 with binary value.",
    "OK_INSERT",
    client.kvU(alice, "k2", fileb1),
    server,
)
cse303.do_cmd("Getting key k2.", "OK__", client.kvG(alice, "k2"), server)
cse303.check_file_result(fileb1, "k2")
cse303.do_cmd(
    "Upserting key k1 with text value.",
    "OK_UPDATE",
    client.kvU(alice, "k1", filet2),
    server,
)
cse303.do_cmd("Getting key k1.", "OK__", client.kvG(alice, "k1"), server)
...
cse303.line()
cse303.do_cmd(
    "Getting all keys with invalid user.", "ERR_LOGIN", client.kvA(bob, allfile), server
)
cse303.do_cmd(
    "Getting all keys with invald password.",
    "ERR_LOGIN",
    client.kvA(fakealice, allfile),
    server,
)
cse303.do_cmd(
    "Getting all keys to make sure it's k1, k2, and k4.",
    "OK__",
...
cse303.do_cmd("Deleting binary key k2.", "OK__", client.kvD(alice, "k2"), server)
cse303.do_cmd(
    "Getting all keys to make sure it's just k4.",
    "OK__",
    client.kvA(alice, allfile),
    server,
)
cse303.check_file_list(allfile, ["k4"])
cse303.do_cmd("Deleting binary key k4.", "OK__", client.kvD(alice, "k4"), server)
cse303.do_cmd(
    "Getting all keys from empty table.",
    "ERR_NO_DATA",
    client.kvA(alice, allfile),
    server,
)
