...
SERVER_MAIN     = server
SERVER_CXX      = my_gatekeeper my_quota_tracker
SERVER_COMMON   = 
SERVER_PROVIDED = server responses parsing concurrentmap_factories persist \
                  my_mru crypto err file net my_pool my_crypto storage
