...
cse303.do_cmd(
    "Calling KVT on an empty K/V store",
    "ERR_NO_DATA",
    client.kvT(alice, topkeys),
    server,
)
...
cse303.line()
cse303.do_cmd("Inserting k1.", "OK__", client.kvI(alice, "k1", valfile), server)
cse303.do_cmd("Inserting k2.", "OK__", client.kvI(alice, "k2", valfile), server)
cse303.do_cmd("Inserting k3.", "OK__", client.kvI(alice, "k3", valfile), server)
...
cse303.line()
cse303.do_cmd("Inserting k4.", "OK__", client.kvI(alice, "k4", valfile), server)
cse303.do_cmd("Inserting k5.", "OK__", client.kvI(alice, "k5", valfile), server)
cse303.do_cmd("Inserting k6.", "OK__", client.kvI(alice, "k6", valfile), server)
cse303.do_cmd("Inserting k7.", "OK__", client.kvI(alice, "k7", valfile), server)
cse303.do_cmd("Inserting k8.", "OK__", client.kvI(alice, "k8", valfile), server)
cse303.do_cmd("Inserting k9.", "OK__", client.kvI(alice, "k9", valfile), server)
cse303.do_cmd("Getting top keys", "OK__", client.kvT(alice, topkeys), server)
...
cse303.line()
cse303.do_cmd("Deleting k4.", "OK__", client.kvD(alice, "k4"), server)
cse303.do_cmd("Deleting k8.", "OK__", client.kvD(alice, "k8"), server)
cse303.do_cmd("Getting top keys", "OK__", client.kvT(alice, topkeys), server)
...
cse303.do_cmd("Getting top keys", "OK__", client.kvT(alice, topkeys), server)
cse303.check_file_list_nosort(
    topkeys, ["k11", "k10", "k5", "k1", "k2", "k3", "k9", "k7"]
)
...
cse303.line()
cse303.do_cmd("Getting key k1 with bob.", "OK__", client.kvG(bob, "k1"), server)
cse303.check_file_result(valfile, "k1")
cse303.do_cmd(
    "Upserting k10 with bob.", "OK_UPDATE", client.kvU(bob, "k10", valfile), server
)
cse303.do_cmd("Deleting k5 with bob.", "OK__", client.kvD(bob, "k5"), server)
cse303.do_cmd(
    "Upserting k12 with bob.", "OK_INSERT", client.kvU(bob, "k12", valfile), server
)
cse303.do_cmd("Getting top keys with alice", "OK__", client.kvT(alice, topkeys), server)
cse303.check_file_list_nosort(
    topkeys, ["k12", "k10", "k1", "k11", "k2", "k3", "k9", "k7"]
)
cse303.do_cmd("Getting top keys with bob", "OK__", client.kvT(bob, topkeys), server)
cse303.check_file_list_nosort(
    topkeys, ["k12", "k10", "k1", "k11", "k2", "k3", "k9", "k7"]
)
