...
public:
  ...
  /// @param on_success Code to run if the operation succeeds
  ///
  /// @return A result tuple, as described above
  virtual result_t kv_insert(const std::string &user, const std::string &pass,
                             const std::string &key,
                             const std::vector<uint8_t> &val,
                             std::function<void()> on_success) = 0;
  ...
  virtual result_t kv_get(const std::string &user, const std::string &pass,
                          const std::string &key,
                          std::function<void(size_t)> on_success) = 0;
  ...
  ///
  /// @return A result tuple, as described above
  virtual result_t kv_all(const std::string &user, const std::string &pass,
                          std::function<void()> on_success) = 0;
