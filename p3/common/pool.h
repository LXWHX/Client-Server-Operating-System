...
///     functions, and then there is "my_pool.cc" which subclasses thread_pool
///     and then implement everything.  While pure virtual methods have overhead
///     in C++, this style of programming allows us to share solutions without
///     sharing code.
class thread_pool {
public:
