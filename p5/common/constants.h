...
/// Get a newline-delimited list of the hottest keys
const std::string REQ_KVT = "TOP_";

/// Response code to indicate a download quota violation
const std::string RES_ERR_QUOTA_DOWN = "ERR_QUOTA_DOWN";

/// Response code to indicate an upload quota violation
const std::string RES_ERR_QUOTA_UP = "ERR_QUOTA_UP";

/// Response code to indicate a request count violation
...
/// Request that map/reduce are run on the key/value store
const std::string REQ_KMR = "KMR_";

/// Register a new shared object with the server
