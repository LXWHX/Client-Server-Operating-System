...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_all(int sd, Gatekeeper *storage, EVP_CIPHER_CTX *ctx,
...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_set(int sd, Gatekeeper *storage, EVP_CIPHER_CTX *ctx,
                const std::string &u, const std::string &p,
                const std::vector<uint8_t> &req);
...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_get(int sd, Gatekeeper *storage, EVP_CIPHER_CTX *ctx,
                const std::string &u, const std::string &p,
                const std::vector<uint8_t> &req);
...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_reg(int sd, Gatekeeper *storage, EVP_CIPHER_CTX *ctx,
                const std::string &u, const std::string &p,
                const std::vector<uint8_t> &req);
...
bool handle_bye(int sd, Gatekeeper *storage, EVP_CIPHER_CTX *ctx,
                const std::string &u, const std::string &p,
                const std::vector<uint8_t> &req);
...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_sav(int sd, Gatekeeper *storage, EVP_CIPHER_CTX *ctx,
                const std::string &u, const std::string &p,
                const std::vector<uint8_t> &req);
...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_kva(int sd, Gatekeeper *storage, EVP_CIPHER_CTX *ctx,
                const std::string &u, const std::string &p,
                const std::vector<uint8_t> &req);
...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_kvi(int sd, Gatekeeper *storage, EVP_CIPHER_CTX *ctx,
                const std::string &u, const std::string &p,
                const std::vector<uint8_t> &req);
...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_kvu(int sd, Gatekeeper *storage, EVP_CIPHER_CTX *ctx,
                const std::string &u, const std::string &p,
                const std::vector<uint8_t> &req);
...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_kvg(int sd, Gatekeeper *storage, EVP_CIPHER_CTX *ctx,
                const std::string &u, const std::string &p,
                const std::vector<uint8_t> &req);
...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_kvd(int sd, Gatekeeper *storage, EVP_CIPHER_CTX *ctx,
                const std::string &u, const std::string &p,
                const std::vector<uint8_t> &req);
...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_kvt(int sd, Gatekeeper *storage, EVP_CIPHER_CTX *ctx,
                const std::string &u, const std::string &p,
                const std::vector<uint8_t> &req);
...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_kvf(int sd, Gatekeeper *storage, EVP_CIPHER_CTX *ctx,
                const std::string &u, const std::string &p,
                const std::vector<uint8_t> &req);
...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_kmr(int sd, Gatekeeper *storage, EVP_CIPHER_CTX *ctx,
                const std::string &u, const std::string &p,
                const std::vector<uint8_t> &req);
