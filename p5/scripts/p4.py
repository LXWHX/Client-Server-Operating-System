...
cse303.do_cmd("Registering new user bob.", "OK__", client.reg(bob), server)
cse303.do_cmd(
    "Setting key k1 to 1K file.", "OK__", client.kvI(alice, "k1", t1kname), server
)
cse303.do_cmd(
    "Setting key k2 to 1K file.", "OK__", client.kvI(alice, "k2", t1kname), server
)
cse303.do_cmd(
    "Updating key k2 to 1K file.", "OK_UPDATE", client.kvU(alice, "k2", t1kname), server
)
cse303.do_cmd(
    "Upserting key k3 to 1K file.",
    "OK_INSERT",
    client.kvU(alice, "k3", t1kname),
    server,
)
cse303.do_cmd(
    "Setting key k4 to 1K file.", "OK__", client.kvI(alice, "k4", t1kname), server
)
cse303.do_cmd(
    "Setting key k5 to 1K file.", "OK__", client.kvI(alice, "k5", t1kname), server
)
cse303.do_cmd(
    "Setting key k6 to 1K file.", "OK__", client.kvI(alice, "k6", t1kname), server
)
cse303.do_cmd(
    "Setting key k7 to 1K file.", "OK__", client.kvI(alice, "k7", t1kname), server
)

cse303.do_cmd(
    "Setting key k8 to 1K file.",
    "ERR_QUOTA_UP",
    client.kvI(alice, "k8", t1kname),
    server,
)
cse303.do_cmd(
    "Updating key k9 to 1K file.",
    "ERR_QUOTA_UP",
    client.kvU(alice, "k9", t1kname),
    server,
)
cse303.do_cmd(
    "Upserting key k7 to 1K file.",
    "ERR_QUOTA_UP",
    client.kvU(alice, "k7", t1kname),
    server,
)
...
cse303.line()
cse303.do_cmd(
    "Upserting key k7 to 1K file.", "OK_UPDATE", client.kvU(bob, "k7", t1kname), server
)
...
cse303.do_cmd("Getting all keys.", "OK__", client.kvA(alice, allkeys), server)
...
cse303.do_cmd("Getting key k3.", "OK__", client.kvG(alice, "k3"), server)
cse303.check_file_result(t1kname, "k3")
cse303.do_cmd("Getting key k4.", "OK__", client.kvG(alice, "k4"), server)
cse303.check_file_result(t1kname, "k4")
cse303.do_cmd("Getting key k5.", "OK__", client.kvG(alice, "k5"), server)
cse303.check_file_result(t1kname, "k5")
cse303.do_cmd("Getting key k6.", "OK__", client.kvG(alice, "k6"), server)
cse303.check_file_result(t1kname, "k6")
cse303.do_cmd("Getting key k7.", "OK__", client.kvG(alice, "k7"), server)
...
cse303.line()
cse303.do_cmd("Getting key k7.", "OK__", client.kvG(bob, "k7"), server)
cse303.check_file_result(t1kname, "k7")
...
cse303.line()
cse303.do_cmd("Deleting key k6.", "OK__", client.kvD(alice, "k6"), server)
cse303.do_cmd("Getting all keys.", "OK__", client.kvA(alice, allkeys), server)
cse303.check_file_list(allkeys, ["k1", "k2", "k3", "k4", "k5", "k7"])

cse303.do_cmd("Getting top keys", "OK__", client.kvT(alice, topkeys), server)
cse303.check_file_list_nosort(topkeys, ["k7", "k5", "k4"])

cse303.do_cmd(
    "Setting key k10 to 1K file.",
    "ERR_QUOTA_REQ",
    client.kvI(alice, "k10", t1kname),
    server,
)
cse303.do_cmd(
    "Upserting key k2 to 1K file.",
    "ERR_QUOTA_REQ",
    client.kvU(alice, "k2", t1kname),
    server,
)
cse303.do_cmd(
    "Updating key k3 to 1K file.",
    "ERR_QUOTA_REQ",
    client.kvU(alice, "k3", t1kname),
    server,
)
...
cse303.check_file_result(t1kname, "k7")
cse303.do_cmd(
    "Setting key k10 to 1K file.", "OK__", client.kvI(alice, "k10", t1kname), server
)
cse303.do_cmd("Getting all keys.", "OK__", client.kvA(alice, allkeys), server)
cse303.check_file_list(allkeys, ["k1", "k2", "k3", "k4", "k5", "k7", "k10"])
cse303.do_cmd("Deleting key k5.", "OK__", client.kvD(alice, "k5"), server)
cse303.do_cmd("Getting all keys.", "OK__", client.kvA(alice, allkeys), server)
...
cse303.do_cmd("Getting key k7.", "OK__", client.kvG(alice, "k7"), server)
cse303.check_file_result(t1kname, "k7")
cse303.do_cmd("Getting key k10.", "OK__", client.kvG(alice, "k10"), server)
